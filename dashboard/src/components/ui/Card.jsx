...
function Card({ title, value, icon }) {
    return (
        <div className="bg-terc w-[320px] h-[130px] mb-10 p-5 border border-transparent rounded-2xl flex justify-between items-center hover:border hover:border-cyan-400 cursor-pointer transition ease-in-out duration-300">
            <div>
